...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Fr 15. Mrz 07:51:10 2013
# Project:  StdFuncs.pro
# Template: lib
# Command: d:/Qt/4.8.4/bin/qmake.exe -spec ../../Qt/4.8.4/mkspecs/win32-g++ CONFIG+=declarative_debug -o Makefile StdFuncs.pro
#############################################################################
...
Makefile: StdFuncs.pro  ../../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../../Qt/4.8.4/mkspecs/features/device_config.prf \
		...
		../../Qt/4.8.4/mkspecs/features/staticlib.prf \
	...
	$(QMAKE) -spec ../../Qt/4.8.4/mkspecs/win32-g++ CONFIG+=declarative_debug -o Makefile StdFuncs.pro
