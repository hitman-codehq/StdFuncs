...
OBJECTS = $(OBJ)/AmiMenus.o $(OBJ)/Args.o $(OBJ)/BaUtils.o $(OBJ)/Dir.o $(OBJ)/File.o $(OBJ)/Lex.o $(OBJ)/MungWall.o \
	...
	$(OBJ)/StdImage.o $(OBJ)/StdPool.o $(OBJ)/StdStringList.o $(OBJ)/StdTextFile.o $(OBJ)/StdWildcard.o $(OBJ)/StdWindow.o \
	$(OBJ)/Test.o $(OBJ)/Time.o $(OBJ)/Utils.o

else

OBJECTS = $(OBJ)/Args.o $(OBJ)/BaUtils.o $(OBJ)/Dir.o $(OBJ)/File.o $(OBJ)/Lex.o $(OBJ)/MungWall.o \
	$(OBJ)/StdConfigFile.o $(OBJ)/StdPool.o $(OBJ)/StdStringList.o $(OBJ)/StdTextFile.o $(OBJ)/StdWildcard.o $(OBJ)/Test.o \
