 ...
 * command is launched asynchronously and a callback is called when the data becomes available. This allows the client
...
public:
	...
	RStdExecuter()
	{
		...
		m_buffer = nullptr;
		m_signal = 0;
		m_stdInRead = m_stdOutRead = m_stdOutWrite = NULL;
		m_port = nullptr;
		m_packet = nullptr;
