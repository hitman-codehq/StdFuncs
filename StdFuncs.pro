...
SOURCES += Qt/QtAction.cpp Qt/QtGadgetSlider.cpp Qt/QtLocalSocket.cpp Qt/QtWindow.cpp
...
HEADERS += Qt/QtAction.h Qt/QtGadgetSlider.h Qt/QtLocalSocket.h Qt/QtWindow.h
